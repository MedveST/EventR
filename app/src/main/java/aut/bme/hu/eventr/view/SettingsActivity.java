...
public class SettingsActivity extends AppCompatPreferenceActivity implements SettingsView {
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        {
            if (preference.getKey().equals("forget_credentials_pref"))
            {
                settingsPresenter.forgetCredentials();
            }
            else if (preference.getKey().equals("auto_remove_switch"))
            {
                settingsPresenter.setAutoRemoveExpiredEvents(preference.getSharedPreferences().getBoolean("auto_remove_switch", false));
            }
